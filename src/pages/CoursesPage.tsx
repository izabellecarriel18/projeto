      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {courses.length === 0 ? (
          <div className="text-center py-12 sm:py-20">
            ...
            <p className="text-gray-400 text-lg sm:text-xl">Nenhum curso disponível no momento</p>
          </div>
        ) : (
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-white font-bold text-xl sm:text-2xl mb-2 sm:mb-3">{course.title}</h3>
                  <p className="text-gray-400 text-sm sm:text-base mb-4 leading-relaxed">{course.description}</p>
                  ...
                  <div className="border-t border-gray-800 pt-4 sm:pt-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      <button className="flex-1 bg-red-600 hover:bg-red-700 text-white py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all">
                        Comprar
                      </button>
                      <button className="flex-1 border-2 border-gray-700 hover:border-red-600 text-white py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all">
                        Ver Conteúdo
                      </button>
                    </div>
                  </div>
        ...
        <div className="backdrop-blur border border-gray-800 rounded-lg p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {guarantees.map((item, index) => (
              <div key={index} className="flex items-center gap-3">
                <div className="bg-red-600/10 p-2.5 sm:p-3 rounded-full">
        ...
        <div className="backdrop-blur border border-gray-800 rounded-lg p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto">
            {checkout.map((item, index) => (
              <div key={index} className="flex items-center gap-3">
                <div className="bg-green-600/10 p-2.5 sm:p-3 rounded-full">
